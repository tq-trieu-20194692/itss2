...
const HomePage = () => {
    ...
    return (
        <div
            style={{backgroundColor: "#F0F2F5", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center"}}>
            ...
            {data.length > visibleData && !showLess && (
                <Button onClick={handleShowMore} style={{marginTop: "20px", marginBottom: "20px"}} type="primary"
                        icon={<PlusCircleOutlined/>}>
                    Show more
                </Button>
            )}
            {showLess && (
                <Button onClick={handleShowLess} style={{marginTop: "20px", marginBottom: "20px"}} type="default"
